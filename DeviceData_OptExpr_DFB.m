function dati=DeviceData_OptExpr_DFB(alphaf, kcoupling) %#codegen
...
'f0',           1.1*10^(-7),...   %um^3
'Vol',          2240,...  %(um^3)
'Gamma',        0.15,... %(Ghz) !!! Half Gain Linewidth MODIFIED from 0.15 to 5.4
'epsb',         3.3^2, ...
'kcoupling', kcoupling, ...%(cm^-1);
'eta_i', 0.8 ... %intrinsic efficiency
);
end
